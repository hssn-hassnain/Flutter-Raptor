...
import 'AppLockActivation.dart';

class AccountVerificationEmail extends StatefulWidget {
  @override
  _AccountVerificationEmailState createState() =>
      _AccountVerificationEmailState();
}

class _AccountVerificationEmailState extends State<AccountVerificationEmail> {
  @override
            ...
            onPressed: () {
              Navigator.push(context,
                  // MaterialPageRoute(builder: (context) => Organizationac()));
                   MaterialPageRoute(builder: (context) => ActiveLock()));
            },
            height: 50.0,
            minWidth: 50.0,
